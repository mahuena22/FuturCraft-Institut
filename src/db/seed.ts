      ...
      .values([
        {
          ...
          duration: "9 mois (6 mois cours + 3 mois stage/projet)",
        ...
        },
        {
          ...
          category: "Intelligence Artificielle",
          shortDescription:
            "Formation intensive accélérée d'1 mois pour booster sa productivité professionnelle grâce aux meilleurs outils d'IA du marché.",
          fullDescription:
            "Un condensé ultra-pratique pour entrepreneurs, cadres, freelances et créateurs de contenu. Apprenez à dompter ChatGPT, Claude, Midjourney, Perplexity, Cursor, Make et Canva IA pour automatiser vos tâches quotidiennes et multiplier par 5 votre efficacité.",
          duration: "1 mois intensif (Cours du soir / Samedi)",
        ...
        },
        {
          ...
          duration: "3 mois (Théorie + Pratique terrain)",
          level: "Tous niveaux (ì partir de 18 ans)",
          price: 280000,
          registrationFee: 25000,
          installmentsCount: 3,
